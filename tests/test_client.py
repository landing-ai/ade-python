...
class TestLandingAiade:
    ...
    def test_hardcoded_query_params_in_url(self, client: LandingAIADE) -> None:
...
class TestAsyncLandingAiade:
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncLandingAIADE) -> None:
