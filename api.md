...
```python
from landingai_ade.types import ExtractResponse, ExtractBuildResponse, ParseResponse, SplitResponse
```
...
- <code title="post /v1/ade/extract/build-schema">client.<a href="./src/landingai_ade/_client.py">extract_build</a>(\*\*<a href="src/landingai_ade/types/client_extract_build_params.py">params</a>) -> <a href="./src/landingai_ade/types/extract_build_response.py">ExtractBuildResponse</a></code>
